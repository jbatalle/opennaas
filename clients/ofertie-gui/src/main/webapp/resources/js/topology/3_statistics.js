...
var dataJson = getPortStatistic(swId, portId);
    ...
    /*
     ...
     element: document.getElementById("chartStats"),
     width: 500,
     height: 300,
     renderer: 'line',
     series: new Rickshaw.Series.FixedDuration([{name: 'throughput'}, {name: 'packetLoss'}], undefined, {
     timeInterval: tv,
     maxDataPoints: 100,
     timeBase: new Date().getTime() / 1000,
     scale: scales[0]
     ...
     //var data = dataJson.timedPortStatistics.statistics.statistic[0].throughput;
     var data = {throughput: dataJson.timedPortStatistics.statistics.statistic[0].throughput,
     packetLoss: dataJson.timedPortStatistics.statistics.statistic[3].pacletLoss};

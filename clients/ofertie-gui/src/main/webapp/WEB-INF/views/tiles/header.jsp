...
<div id="header_menu" class="ui-widget-content ui-corner-all">
    <div id="home">
        <a href="<c:url value="${url}/secure/ofertie/home" />"><button id="homeButton" class="button" style="margin: 0px"><spring:message code="header.home"/></button></a>
    </div>

    <ul id="nav">
        <li>
            <a href="<c:url value="${url}/secure/ofertie/circuits" />">
                <spring:message code="menu.RouteTable" />
            </a>
        </li>
        <li>
            <a href="<c:url value="${url}/secure/ofertie/statistics" />">
                <spring:message code="menu.Statistics" />
            </a>
        </li>
        <li>
            <a href="<c:url value="${url}/secure/ofertie/settings" />">

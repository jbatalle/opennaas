...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/resources/css/opennaas.css" />" type="text/css">
        ...
        <!-- Rickshaw -->
        <link rel="stylesheet" href="<c:url value="/resources/css/graph.css" />" type="text/css">
        <link rel="stylesheet" href="<c:url value="/resources/css/detail.css" />" type="text/css">
        <link rel="stylesheet" href="<c:url value="/resources/css/legend.css" />" type="text/css">
        <link rel="stylesheet" href="<c:url value="/resources/css/extensions.css" />" type="text/css">
        	<style type="text/css">
  #axis0 {
    position: absolute;
    float:left;
